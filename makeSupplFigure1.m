function [ng2_dataC, ng2table, ng2_ratios, ng2stats, gfap_dataC, gfaptable, gfap_ratios, gfapstats] = makeSupplFigure1(showplots,showstats)
...
if showstats
    figure
    multcompare(ng2stats.ratioKWstats,'CType','lsd');
end
%% gfap count data
...
if showstats
    figure
    multcompare(gfapstats.ratioKWstats,'CType','lsd');
end
end